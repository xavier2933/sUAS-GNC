...
%aircraft_parameters = utils.raaven();
...
for i=1:n_ind
    ...
    %%%
    control_objectives(1) = 1800;
    control_objectives(2) = 0;
    control_objectives(3) = 60 * pi / 180;
    control_objectives(4) = 0;
    control_objectives(5) = 20;
    %%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
