...
control_gains.max_da        = 30*pi/180;%%%<---------- FREW SELECTED
control_gains.max_dr        = 30*pi/180;%%%<---------- FREW SELECTED
control_gains.max_de        = 20*pi/180;%%%<---------- FREW SELECTED
...
%%%%%%%
% course hold gains
wn_chi = (1/22)*wn_roll; %%%<---------- STUDENT SELECT
...
zeta_height = 1.2; %%%<---------- STUDENT SELECT
...
wn_airspeed = (1/100)*wn_pitch; %%%<---------- STUDENT SELECT
...
wn_airspeed = (1/40)*wn_pitch; %%%<---------- STUDENT SELECT
zeta_airspeed = 1.2; %%%<---------- STUDENT SELECT
