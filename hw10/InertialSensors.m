...
density = utils.stdatmo(height);

wind_body = utils.TransformFromInertialToBody(wind_inertial, aircraft_state(4:6,1));
air_rel_body = aircraft_state(7:9,1) - wind_body;
wind_angles = utils.AirRelativeVelocityVectorToWindAngles(air_rel_body);


[fa_body, ma_body] = utils.AeroForcesAndMoments_BodyState_WindCoeffs(aircraft_state, aircraft_surfaces, wind_inertial, density, aircraft_parameters);
Va = wind_angles(1);
